...
The resulting code style of each solution is probably subject to individual taste.
...
- 50h: Extract messages and actually translate them (into the desired languages)
