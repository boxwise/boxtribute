...
@pytest.mark.parametrize(
    ...
    [
        ...
        [[{"states": "[InTransit]"}], 2],
        [[{"states": "[Receiving]"}], 0],
        [[{"states": "[NotDelivered]"}], 1],
        [[{"states": "[InStock,Lost]"}], 2],
        [[{"states": "[Lost,MarkedForShipment]"}], 4],
        [[{"lastModifiedFrom": '"2020-01-01"'}], 8],
        [[{"lastModifiedFrom": '"2021-02-02"'}], 2],
        [[{"lastModifiedFrom": '"2022-01-01"'}], 0],
        [[{"lastModifiedUntil": '"2022-01-01"'}], 8],
        [[{"lastModifiedUntil": '"2020-11-27"'}], 6],
        [[{"lastModifiedUntil": '"2020-01-01"'}], 0],
        [[{"productGender": "Women"}], 8],
        [[{"productGender": "Men"}], 0],
        [[{"productCategoryId": "1"}], 8],
