...
@product.field("transferItemsCount")
def resolve_transfer_items_count(product_obj, info):
    return info.context["transfer_items_count_for_product_loader"].load(product_obj.id)
