...
describe("filterByTags", () => {
  ...
  it("filters by multiple excluded tags", () => {
    const result = filterByTags(mockData, [], [tag1, tag3]);
    expect(result).toHaveLength(2);
  ...
  it("filters by both included and excluded tags", () => {
    ...
    const result = filterByTags(mockData, [tag2], [tag3]);
  ...
  it("handles undefined tagIds", () => {
    ...
    const result = filterByTags(dataWithUndefined, [tag1], []);
