...
/** Representation of a box storing items of a [`Product`]({{Types.Product}}) in a [`ClassicLocation`]({{Types.ClassicLocation}}) */
 ...
 */
export type ClassicLocation = BoxPlace & {
