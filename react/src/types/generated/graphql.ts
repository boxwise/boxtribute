...
export type AssignBoxToShipmentMutation = {
  __typename?: "Mutation";
  updateShipmentWhenPreparing?: {
    ...
    details: Array<{
      ...
      deletedBy?: { __typename?: "User"; id: string; name?: string | null } | null;
    }>;
    sourceBase: {
      __typename?: "Base";
      id: string;
...
export type BasesQuery = {
  __typename?: "Query";
  bases: Array<{ __typename?: "Base"; id: string; name: string }>;
};
...
export type BoxFieldsFragment = {
  ...
  location?:
    ...
    | null;
  tags?: Array<{ __typename?: "Tag"; id: string; name: string; color?: string | null }> | null;
  history?: Array<{
    __typename?: "HistoryEntry";
    id: string;
    changes: string;
