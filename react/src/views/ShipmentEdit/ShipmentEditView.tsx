...
import { ShipmentByIdQuery, ShipmentByIdQueryVariables, UpdateShipmentMutation, UpdateShipmentMutationVariables } from "types/generated/graphql";
...
const ShipmentEditView = () => {
  ...
  >(UPDATE_SHIPMENT_MUTATION);
    ...
    return (
        <ShipmentEdit shipmentData={shipmentData} onSubmitUpdateShipment={onSubmitUpdateShipment}/>
     );
}
