...
export type AllAvailableBasesQueryVariables = Exact<{
  orgId: Scalars['ID']['input'];
}>;


export type AllAvailableBasesQuery = { __typename?: 'Query', organisation?: { __typename?: 'Organisation', id: string, name: string, bases?: Array<{ __typename?: 'Base', id: string, name: string }> | null } | null };
