...
import { BOX_FIELDS_FRAGMENT, DISTRO_EVENT_FIELDS_FRAGMENT } from "./fragments";
import { SHIPMENT_DETAIL_FIELDS_FRAGMENT, SHIPMENT_FIELDS_FRAGMENT, TRANSFER_AGREEMENT_FIELDS_FRAGMENT } from "../../../graphql/fragments";
